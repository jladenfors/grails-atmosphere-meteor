...
target('default': "Active Atmosphere Meteor Plugin") {
...
// Copy the default plugin configuration file
    if (!atmosphereMeteorConfigFile.exists()) {
        ant.copy(file: "${atmosphereMeteorPluginDir}/src/templates/conf/AtmosphereMeteorConfig.groovy", todir: "${basedir}/grails-app/conf")
    }
...
// Copy the default plugin resources file
    ...
    ant.copy(file: "${atmosphereMeteorPluginDir}/src/templates/conf/AtmosphereMeteorResources.groovy", todir: "${basedir}/grails-app/conf")
...
""")
    ...
    if (!atmosphereMeteorResourcesFileExists) {
        println """
********************************************************************
* You have activated the atmosphere-meteor plugin.                 *
*                                                                  *
* Documentation:                                                   *
...
"""
        ...
        println """
***********************************************************
* You have reactivated the atmosphere-meteor plugin.      *
*                                                         *
* Documentation:                                          *
* https://github.com/kensiprell/grails-atmosphere-meteor  *
*                                                         *
